...
import (
	...
	. "github.com/bcandido/kafka-topic-manager/pkg/apis/kafka/v1"
	. "github.com/bcandido/kafka-topic-manager/pkg/client/clientset_generated/clientset/typed/kafka/v1"
)

var _ = Describe("KafkaTopic", func() {
	var instance KafkaTopic
	var expected KafkaTopic
	var client KafkaTopicInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.KafkaV1().KafkaTopics("kafkatopic-test-valid")

...
// +k8s:conversion-gen=github.com/bcandido/kafka-topic-manager/pkg/apis/kafka
// +k8s:defaulter-gen=TypeMeta
// +groupName=kafka.kafka-topic-manager.kubernetes.bcandido.com
package v1 // import "github.com/bcandido/kafka-topic-manager/pkg/apis/kafka/v1"

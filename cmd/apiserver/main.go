...
import (
	...
	"github.com/bcandido/kafka-topic-manager/pkg/apis"
	"github.com/bcandido/kafka-topic-manager/pkg/openapi"
	_ "github.com/bcandido/kafka-topic-manager/plugin/admission/install"
)
...
func main() {
	...
	err := server.StartApiServerWithOptions(&server.StartOptions{
		EtcdPath:         "/registry/kafka-topic-manager.kubernetes.bcandido.com",
